...
def main() -> None:
    ...
    ensure(volume["breathing_class"] == "moderate-breathing", "battery-analysis should classify the breathing scale")
    ...
    ensure(neb["kinetic_class"] == "moderate-like", "battery-analysis should classify the migration barrier scale")
